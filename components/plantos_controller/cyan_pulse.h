...
/**
 * CyanPulseBehavior - Cyan pulse for pH injection
 *
 * Visual feedback for PH_INJECTING state.
 * Cyan LED pulses (30% to 100% brightness).
 *
 * Continuous behavior (never completes).
 */
class CyanPulseBehavior : public LedBehavior {
public:
